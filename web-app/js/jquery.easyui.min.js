...
(function ($) {
    ...
    function _2f8(_2f9, _2fa) {
        ...
        if (_2fa) {
            ...
            var _2fd = null;
            _2fb.bind("mouseenter.splitbutton",
                function () {
...
(function ($) {
    ...
    function _30c(_30d) {
        ...
        _30f.unbind(".searchbox").bind("blur.searchbox",
            function (e) {
                opts.value = $(this).val();
                if (opts.value == "") {
        ...
        _310.unbind(".searchbox").bind("click.searchbox",
            function () {
                var name = $.fn.prop ? _30f.prop("name") : _30f.attr("name");
                opts.searcher.call(_30d, opts.value, name);
...
(function ($) {
    ...
    function _35b(_35c) {
        ...
        $(_35c).unbind(".numberbox").bind("keypress.numberbox",
            function (e) {
                if (e.which == 45) {
                    return true;
                }
...
(function ($) {
    ...
    function init(_370) {
        ...
        $(_370).find(".calendar-title span").hover(
            function () {
    ...
    function _377(_378) {
        ...
        if ($(_378).find(".calendar-menu-month-inner").is(":empty")) {
            ...
            $(_378).find(".calendar-menu-month").hover(
                function () {
                    $(this).addClass("calendar-menu-hover");
                },
                function () {
...
(function ($) {
    ...
    function _41c(_41d) {
        ...
        _41f.find("td:has(div.datagrid-cell)").unbind(".datagrid").bind("mouseenter.datagrid",
            function () {
