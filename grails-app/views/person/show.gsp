...
<div class="body">
    ...
    <div class="dialog">
        <table>
            ...
            <tr class="prop">
                <td valign="top" class="name"><g:message code="person.accountExpired.label"
            ...
            <tr class="prop">
                <td valign="top" class="name"><g:message code="person.accountLocked.label"
            ...
            <tr class="prop">
                <td valign="top" class="name"><g:message code="person.createRequests.label"
