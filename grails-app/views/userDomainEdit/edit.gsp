...
<tr class="prop">
    <td valign="top" class="name">
        <label for="offeredSkills"><g:message code="user.offeredSkills.label" default="Offered Skills"/></label>
    </td>
...
<tr class="prop">
    <td valign="top" class="name">
        <label for="createdRequests"><g:message code="user.createdRequests.label" default="Created Requests"/></label>
    </td>
...
<tr class="prop">
    ...
    <td valign="top" class="value ${hasErrors(bean: userInstance, field: 'exchangesProvided', 'errors')}">
...
<tr class="prop">
    ...
    <td valign="top" class="value ${hasErrors(bean: userInstance, field: 'exchangesReceived', 'errors')}">
...
<tr class="prop">
    <td valign="top" class="name">
        <label for="referees"><g:message code="user.referees.label" default="Referees"/></label>
    </td>
    <td valign="top" class="value ${hasErrors(bean: userInstance, field: 'referees', 'errors')}">
        ...
        <ul class="one-to-many">
            ...
            <li class="add">
                <g:link controller="referee" action="create"
                        params="['user.id': userInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'referee.label', default: 'Referee')])}</g:link>
            </li>
        </ul>
