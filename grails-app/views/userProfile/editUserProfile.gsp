...
<head>
    ...
    <title><g:message code="default.edit.user"/></title>
...
<div class="body">
    <h4><g:message code="default.edit.user"/></h4>
    ...
    <g:form method="post" controller="userProfile" action="updateUserProfile">
        ...
        <div class="dialog">
            <table>
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="offeredSkills"><g:message code="user.skills.label"
                                                              default="User Skills"/></label>
                    </td>
        ...
        <div class="buttons">
            <span class="button"><g:actionSubmit class="save" action="updateUserProfile"
